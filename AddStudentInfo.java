...
class Student extends Teacher implements Serializable{
	 ...
	 */
	Student(String tId, String sId, String sName, String sMajor, String sCredCom, String sGender,String  sAttend, String sCgpa){
    	...
    	addButton.addActionListener(new ActionListener() {
    		public void actionPerformed(ActionEvent e)  {
    			...
    			try {
    				...
    				File file = new File("F:\\eclipse-workspace\\students.txt");
